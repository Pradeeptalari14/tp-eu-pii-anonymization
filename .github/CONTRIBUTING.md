...
Thank you for your interest in improving the **EU PII Anonymization (Multilingual)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-eu-pii-anonymization.git
...
Generated configurations come from the **[EU PII Anonymization (Multilingual) Studio](https://pradeeptalari14.github.io/portfolio/tools/eu-pii-anonymization/)**.
