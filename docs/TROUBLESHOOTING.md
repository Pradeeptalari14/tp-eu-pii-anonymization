# 🔧 Troubleshooting Guide — EU PII Anonymization (Multilingual)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-eu-pii-anonymization/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/eu-pii-anonymization/)
